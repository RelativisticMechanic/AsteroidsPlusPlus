...
#define SPACESHIP_DEFAULT_COLOR { 255, 255, 255, 255 }
#define SPACESHIP_FLASHING_COLOR { 255, 0, 0 ,255 }
#define SPACESHIP_HIT_COOLDOWN_TIME_MS 1500.0f
#define SPACESHIP_DEFAULT_RADIUS 30.0f 
